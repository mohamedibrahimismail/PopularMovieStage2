...
public class FavoritesAdapter extends RecyclerView.Adapter<FavoritesAdapter.MoviewViewHolder> {

    private Context context;
    private List<Favorite> results;
    private String baseImageUrl = "http://image.tmdb.org/t/p/w185/";
    private FavoriteSwitcher switcher;

    public FavoritesAdapter(Context context, List<Favorite> results){

        this.context = context;
        this.results = results;
        this.switcher = (FavoriteSwitcher) context;
    }
    ...
    public void onBindViewHolder(@NonNull MoviewViewHolder moviewViewHolder, int i) {
        ...
        Picasso.get().load(baseImageUrl+results.get(i).getPoster()).into(moviewViewHolder.imageView);
        ...
        public MoviewViewHolder(@NonNull View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    switcher.getFavoritePosition(results.get(getAdapterPosition()));
                }
            });
